  ...
  return (
    <PermissionGuard permission={Permission.ACCESS_BILLING}>
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-slate-900">Billing & Cashier Gate</h1>
          <p className="text-sm text-slate-500 mt-1">Verification workspace for billing personnel.</p>
        </div>
          ...
          <div className="flex items-center gap-3 p-4 bg-teal-50/50 border border-teal-100 rounded-md">
            ...
            <div>
              ...
              <p className="text-xs text-teal-650 mt-0.5">
                The terminal session possesses the `{Permission.ACCESS_BILLING}` permission node.
              </p>
            </div>
          </div>
